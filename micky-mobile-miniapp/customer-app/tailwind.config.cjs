    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": {
            filter:
              "drop-shadow(0 0 20px rgba(100, 180, 255, 0.4)) drop-shadow(0 8px 20px rgba(0, 0, 0, 0.25))",
          },
          "50%": {
            filter:
              "drop-shadow(0 0 35px rgba(100, 180, 255, 0.6)) drop-shadow(0 8px 20px rgba(0, 0, 0, 0.25))",
          },
        },
      },
      animation: {
